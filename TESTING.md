...
- `eslint-plugin-jsx-a11y` active in the lint gate. Remaining Gate 6 items (axe scan, full-life keyboard walk-through narrative, Lighthouse, legal sweep) still open.
