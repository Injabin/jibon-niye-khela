...
export function StickyHeader({ character }: StickyHeaderProps) {
  return (
    <header
      className="sticky top-0 z-20 rounded-md border-b border-border bg-surface/95 backdrop-blur-xl"
      ...
      <div className="w-full px-4 py-3">
        <div className="flex items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-3">
            <div
              className="size-12 shrink-0 overflow-hidden rounded-2xl bg-surface-raised border border-border p-1 flex items-center justify-center shadow-inner"
            >
          ...
          <div className="shrink-0 text-right">
            <p className="text-sm font-bold tabular-nums text-text">
              {character.age}{' '}
              <span className="text-[11px] font-normal text-text-muted">বছর বয়স</span>
            </p>
            <div
              className="mt-0.5 flex items-center justify-end gap-1 text-xs font-bold tabular-nums text-wealth-text"
              data-testid="money"
            >
        ...
        <div className="mt-2.5 grid grid-cols-2 gap-x-4 gap-y-2 pt-2 border-t border-border">
